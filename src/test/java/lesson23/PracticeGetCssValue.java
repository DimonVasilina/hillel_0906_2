...
public class PracticeGetCssValue {
    ...
    public void assertTest() {
        ...
        WebElement buyBtn = driver.findElement(By.xpath("//*[contains(@class,'product-button__buy')]//button"));
        String buyBtnColor = buyBtn.getCssValue("background-color");
        Assert.assertEquals(buyBtnColor, EXPECTED_BUY_BTN_COLOR, "Buy button color are nor ");
